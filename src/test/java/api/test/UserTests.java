...
public class UserTests 
{
	...
	public void testPostUser()
	{
		...
		Response response=UserEndPoints.createUser(userPayload);   //UserEndPoints is the class we created under the package api.endpoints
	...
	public void testGetUserByName()
	{
		...
		Response response=UserEndPoints.readUser(this.userPayload.getUsername());   //getUsername(), this is the getter we set in the User.cs in under the class api.payload 
